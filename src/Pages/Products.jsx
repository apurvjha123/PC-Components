...
import { deleteProducts, getProducts } from "../Redux/callApi";
...
const Products = () => {
  ...
  const handleDelete= (e)=>{
    const ids = e.target.getAttribute("id")
    deleteProducts(dispatch, ids)
  }
  const handleEdit = (e)=>{
    const id = e.target.getAttribute('id_edit')
    history(`/products/${id}`)
  }
  return (
